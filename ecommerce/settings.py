...
DATABASES = {
    'default': {
        ...
        'PASSWORD': '',                        # MySQL password (empty by default in Laragon)
...
EMAIL_HOST_USER = 'marionda040908@gmail.com' # - Enter your GMAIL address # The host email that sends password reset emails
EMAIL_HOST_PASSWORD = 'vsfj wygq bqug jyme' # - Enter your app password 
